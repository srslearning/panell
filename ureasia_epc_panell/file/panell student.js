...
const scriptURL = "https://script.google.com/macros/s/AKfycbwoGJm7L3Fq2Is-xSMjGCLdvz-zsD9hkcazGzsv3TUYkzZWii4-vAdojDzwhTq21e16/exec";
...
<div class="space-y-2">
  <div class="flex gap-2">
    ...
    <button
      onclick="document.getElementById('${iframeId}-webgl')?.requestFullscreen()"
      class="bg-green-500 text-white text-xs px-3 py-1 rounded hover:bg-green-600">
      نمایش تمام‌صفحه
    </button>

    <!-- خروج از fullscreen (امن ۱۰۰٪ برای کپچا) -->
    <button
      onclick="document.exitFullscreen()"
      class="bg-gray-700 text-white text-xs px-3 py-1 rounded hover:bg-gray-800">
      خروج از تمام‌صفحه
    </button>

    <button
      onclick="document.getElementById('${iframeId}-warning').classList.remove('hidden')"
      class="bg-red-600 text-white text-xs px-3 py-1 rounded hover:bg-red-700">
      هشدار!
    </button>
